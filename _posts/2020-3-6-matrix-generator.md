...
foo = new() or new(_row = 1, _col = 2) # makes new sympy Matrix object. You will enter elements
...
1. `new( )`:
  - If you enter noting or only one argument, `new` function will ask you the dimension of the matrix.
